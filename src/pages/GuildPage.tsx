    ...
    <div className="guild-page h-[100dvh] w-screen flex flex-col relative overflow-hidden">
      ...
      <header className="absolute top-0 left-0 right-0 w-full flex justify-between items-center p-6 md:p-8 z-50 pointer-events-none">
        <button
          ...
          aria-label="Back to IntelliDraw canvas"
          title="Back to IntelliDraw canvas"
          className="flex items-center gap-4 pointer-events-auto hover:opacity-70 focus-visible:ring-2 focus-visible:ring-black/30 focus-visible:ring-offset-4 transition-opacity cursor-pointer bg-transparent border-none outline-none"
        >
          <div className="w-8 h-8 border-[1.5px] border-black flex items-center justify-center bg-white/40 backdrop-blur-sm">
            <svg
              aria-hidden="true"
              width="18"
              height="18"
